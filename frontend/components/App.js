...
export default function App() {
  ...
  const onChange = evt => {
    setValue({ ...value, [evt.target.id]: evt.target.value })
  ...
  const submitNewMember = () => {
    ...
    setMembers(members.concat({
      id: getId(), fname: value.fname, lname: value.lname, bio: value.bio
    }))
  }
      ...
      <div id="membersForm">
        ...
        <form>
          <div>
            ...
            <input id="fname" type="text" placeholder="Type First Name" value={value.fname} onChange={onChange}/>
          </div>

          <div>
            <label htmlFor="lname">Last Name </label>
            <input id="lname" type="text" placeholder="Type Last Name" value={value.lname} onChange={onChange}/>
          </div>

          <div>
            <label htmlFor="bio">Bio </label>
            <textarea id="bio" placeholder="Type Bio" value={value.bio} onChange={onChange}/>
          </div>
